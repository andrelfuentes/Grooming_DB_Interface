...
$query = "select nombre_c, nombre from preferencia_cliente natural join empleado;";
...
<body>
<br>
<!-- hacer referencia a clientes.php y empleados.php en botones
...
<a href="empleados.php" class="button2">Ver Informaci&oacute;n de Empleados</a>
</body>
