...
$query = "select nombre_m, nombre from especialidad_mascota natural join empleado;";
...
<body>
<br>
<!-- hacer referencia a mascotas.php y empleados.php en botones
